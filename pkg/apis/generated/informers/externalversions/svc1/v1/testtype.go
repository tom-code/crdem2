...
import (
	versioned "crdem/pkg/apis/generated/clientset/versioned"
	internalinterfaces "crdem/pkg/apis/generated/informers/externalversions/internalinterfaces"
	v1 "crdem/pkg/apis/generated/listers/svc1/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.Svc1V1().TestTypes(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Svc1V1().TestTypes(namespace).Watch(options)
			},
		},
		&svc1v1.TestType{},
		resyncPeriod,
...
func (f *testTypeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&svc1v1.TestType{}, f.defaultInformer)
}
